...
/**
 * Define the TestMessage11 ASN.1 type included in the DSRC ASN.1 module.
 * @see Sequence
 */

public class TestMessage11 extends Sequence implements JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
	...
	/** Decode root fields **/
		...
		if (coder.getOption(com.oss.coders.Coder.cAUTOMATIC_ENCDEC)) {
		    ...
		    REG_EXT_ID_AND_TYPE_OSET oset1 = REGION.reg_TestMessage11;
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, TestMessage11 data)
	    throws IOException, EncoderException, EncodeFailedException
    {
	int nbits = 0;
	...
	try {
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "TestMessage11");
	    throw ee;
	}
    }
     ...
     * @exclude
     */
    public static TestMessage11 decodeValue(PerCoder coder, InputBitStream source, TestMessage11 data)
	    throws IOException, DecoderException, DecodeFailedException
    {
 ...
 // coder.setUnknownExtensionFound();
	...
	try {
	    ...
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "TestMessage11");
	    throw de;
	}
    }
     ...
     * @exclude
     */
    public TestMessage11 decodeValue(JsonCoder coder, JsonReader source)
	    throws IOException, DecoderException
    {
	boolean[] present0 = new boolean[3];
    ...
    public boolean abstractEqualTo(AbstractData that)
    {
	return equalTo((TestMessage11)that);
    }
    ...
    public boolean equalTo(TestMessage11 that) {
	if (this.header != null) {
     ...
     * Clone 'this' object.
     */
    public TestMessage11 clone() {
	TestMessage11 copy = (TestMessage11)super.clone();
	if (header != null) {

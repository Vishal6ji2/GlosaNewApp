...
import com.example.glosanewapp.j2735.itis.ITIScodesAndText;
import com.oss.asn1.*;
...
public class TravelerDataFrame extends Sequence {
	...
	public static Content createContentWithAdvisory(ITIScodesAndText advisory)
	{
	...
	{
	    if (hasAdvisory())
		return (ITIScodesAndText)mChosenValue;
	    else
		return null;
	}
		...
		throws IOException, EncoderException, EncodeFailedException
	{
		...
		case advisory_chosen:
		    ...
		    try {
			ITIScodesAndText item1 = (ITIScodesAndText)data.mChosenValue;

			nbits += ITIScodesAndText.encodeValue(coder, sink, item1);
		    } catch (Exception e) {
			EncoderException ee = EncoderException.wrapException(e);
		...
		throws IOException, DecoderException, DecodeFailedException
	{
		...
		case advisory_chosen:
		    ...
		    try {
			ITIScodesAndText item1 = new ITIScodesAndText();
		...
		throws IOException, EncoderException
	{
		...
		// Encode alternative 'advisory'
		try {
		    ITIScodesAndText item1 = (ITIScodesAndText)this.mChosenValue;
		...
		throws Exception
	{
		...
		try {
		    ...
		    ((ITIScodesAndText)this.mChosenValue).printValue(printer, writer);
		} catch (Exception e) {
		    printer.reportError(e, null, writer);
		}
		break;

...
/**
 * Define the PedestrianBicycleDetect ASN.1 type included in the DSRC ASN.1 module.
 * @see BOOLEAN
 */
...
public class PedestrianBicycleDetect extends BOOLEAN {
     ...
     * Clone 'this' object.
     */
    public PedestrianBicycleDetect clone() {
	return (PedestrianBicycleDetect)super.clone();
    }

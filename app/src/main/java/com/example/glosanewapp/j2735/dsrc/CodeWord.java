...
/**
 * Define the CodeWord ASN.1 type included in the DSRC ASN.1 module.
 * @see OctetString
 */

public class CodeWord extends OctetString implements JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
	...
	try {
	    ...
	    return com.oss.coders.per.PerOctets.encode(coder, this.mValue, 1, 16, sink);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "CodeWord");
	    throw ee;
	}
    }
    ...
    {
	try {
	    this.mValue = com.oss.coders.per.PerOctets.decode(coder, source, 1, 16);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "CodeWord");
	    throw de;
	}
    }

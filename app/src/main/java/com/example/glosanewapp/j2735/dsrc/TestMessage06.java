...
/**
 * Define the TestMessage06 ASN.1 type included in the DSRC ASN.1 module.
 * @see Sequence
 */

public class TestMessage06 extends Sequence implements JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
	...
	/** Decode root fields **/
		...
		if (coder.getOption(com.oss.coders.Coder.cAUTOMATIC_ENCDEC)) {
		    ...
		    REG_EXT_ID_AND_TYPE_OSET oset1 = REGION.reg_TestMessage06;
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, TestMessage06 data)
	    throws IOException, EncoderException, EncodeFailedException
    {
	int nbits = 0;
	...
	try {
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "TestMessage06");
	    throw ee;
	}
    }
     ...
     * @exclude
     */
    public static TestMessage06 decodeValue(PerCoder coder, InputBitStream source, TestMessage06 data)
	    throws IOException, DecoderException, DecodeFailedException
    {
 ...
 // coder.setUnknownExtensionFound();
	...
	try {
	    ...
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "TestMessage06");
	    throw de;
	}
    }
     ...
     * @exclude
     */
    public TestMessage06 decodeValue(JsonCoder coder, JsonReader source)
	    throws IOException, DecoderException
    {
	boolean[] present0 = new boolean[3];
    ...
    public boolean abstractEqualTo(AbstractData that)
    {
	return equalTo((TestMessage06)that);
    }
    ...
    public boolean equalTo(TestMessage06 that) {
	if (this.header != null) {
     ...
     * Clone 'this' object.
     */
    public TestMessage06 clone() {
	TestMessage06 copy = (TestMessage06)super.clone();
	if (header != null) {

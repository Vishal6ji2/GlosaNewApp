...
/**
 * Define the Duration ASN.1 type included in the DSRC ASN.1 module.
 * @see INTEGER
 */

public class Duration extends INTEGER implements JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
	...
	try {
	    ...
	    if (temp0 < 0 || temp0 > 3600)
		throw new EncoderException(ExceptionDescriptor._valueRange, null, temp0);
	    return coder.encodeConstrainedWholeNumber(temp0, 0, 3600, sink);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "Duration");
	    throw ee;
	}
    }
	...
	try {
	    ...
	    temp0 = coder.decodeConstrainedWholeNumber(source, 0, 3600);
	    if (temp0 > 3600)
	    ...
	    de.appendFieldContext(null, "Duration");
	    throw de;
	}
    }

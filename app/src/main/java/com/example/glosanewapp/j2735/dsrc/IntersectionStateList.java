...
/**
 * Define the IntersectionStateList ASN.1 type included in the DSRC ASN.1 module.
 * @see SequenceOf
 */
...
public class IntersectionStateList extends SequenceOf<IntersectionState> {
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, IntersectionStateList data)
     ...
     * @exclude
     */
    public static IntersectionStateList decodeValue(PerCoder coder, InputBitStream source, IntersectionStateList data)
     ...
     * @exclude
     */
    public IntersectionStateList decodeValue(JsonCoder coder, JsonReader source)
    ...
    public void printValue(DataPrinter printer, java.io.PrintWriter writer)
	    throws Exception
    {
	java.util.ArrayList<IntersectionState> temp0 = this.elements;
    ...
    {
	return equalTo((IntersectionStateList)that);
    }
    ...
    public boolean equalTo(IntersectionStateList that) {
     ...
     * Clone 'this' object.
     */
    public IntersectionStateList clone() {
	IntersectionStateList copy = (IntersectionStateList)super.clone();

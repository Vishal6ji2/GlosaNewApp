...
/**
 * Define the DrivenLineOffsetLg ASN.1 type included in the DSRC ASN.1 module.
 * @see INTEGER
 */
...
public class DrivenLineOffsetLg extends INTEGER {
     ...
     * Clone 'this' object.
     */
    public DrivenLineOffsetLg clone() {
	DrivenLineOffsetLg copy = (DrivenLineOffsetLg)super.clone();

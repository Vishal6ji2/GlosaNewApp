...
/**
 * Define the RequestedItemList ASN.1 type included in the DSRC ASN.1 module.
 * @see SequenceOf
 */
...
public class RequestedItemList extends SequenceOf<RequestedItem> {
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, RequestedItemList data)
     ...
     * @exclude
     */
    public static RequestedItemList decodeValue(PerCoder coder, InputBitStream source, RequestedItemList data)
     ...
     * @exclude
     */
    public RequestedItemList decodeValue(JsonCoder coder, JsonReader source)
    ...
    public void printValue(DataPrinter printer, java.io.PrintWriter writer)
	    throws Exception
    {
	java.util.ArrayList<RequestedItem> temp0 = this.elements;
    ...
    {
	return equalTo((RequestedItemList)that);
    }
    ...
    public boolean equalTo(RequestedItemList that) {
     ...
     * Clone 'this' object.
     */
    public RequestedItemList clone() {
	RequestedItemList copy = (RequestedItemList)super.clone();

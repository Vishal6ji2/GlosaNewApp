...
/**
 * Define the LaneAttributes-Vehicle ASN.1 type included in the DSRC ASN.1 module.
 * @see BitString
 */
...
public class LaneAttributes_Vehicle extends BitString {
     ...
     * Clone 'this' object.
     */
    public LaneAttributes_Vehicle clone() {
	return (LaneAttributes_Vehicle)super.clone();
    }

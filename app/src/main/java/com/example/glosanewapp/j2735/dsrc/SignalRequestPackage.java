...
/**
 * Define the SignalRequestPackage ASN.1 type included in the DSRC ASN.1 module.
 * @see Sequence
 */
...
public class SignalRequestPackage extends Sequence {
	...
	/**
	 * Define the _seq43 ASN.1 type included in the DSRC ASN.1 module.
	 * @see Sequence
	 */
	public static class Sequence_ extends Sequence {
		...
		try {
			...
			REG_EXT_ID_AND_TYPE_OSET oset1 = REGION.reg_SignalRequestPackage;
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, SignalRequestPackage data)
	    throws IOException, EncoderException, EncodeFailedException
    {
	int nbits = 0;
     ...
     * @exclude
     */
    public static SignalRequestPackage decodeValue(PerCoder coder, InputBitStream source, SignalRequestPackage data)
	    throws IOException, DecoderException, DecodeFailedException
    {
 ...
 // coder.setUnknownExtensionFound();
     ...
     * @exclude
     */
    public SignalRequestPackage decodeValue(JsonCoder coder, JsonReader source)
	    throws IOException, DecoderException
    {
    ...
    public boolean abstractEqualTo(AbstractData that)
    {
	return equalTo((SignalRequestPackage)that);
    }
    ...
    public boolean equalTo(SignalRequestPackage that) {
     ...
     * Clone 'this' object.
     */
    public SignalRequestPackage clone() {
	SignalRequestPackage copy = (SignalRequestPackage)super.clone();

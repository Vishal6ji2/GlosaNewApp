...
import com.example.glosanewapp.j2735.dsrc.PayloadData;
...
/**
 * Define sample code for the PayloadData ASN.1 type included in the DSRC ASN.1 module.
 * @see PayloadData
 */

public class PayloadDataSample extends SampleUtil {

    /**
     * The default constructor. The class is not instantiable.
     */
    private PayloadDataSample() {}

    /**
     * Create Sample Value.
     */
    public static PayloadData createSampleValue()
    {
	PayloadData value = new PayloadData(new byte[]
	{
	    (byte)0x00
	});
	return value;
    ...
    public static void printValue(PayloadData value, PrintStream s)
    {
	
	s.print(value);
    }
    
    public static int encodeDecodeAndPrint(PayloadData value, int run)
    {
	...
	PayloadData decoded = null;
	try {
	    System.out.print("\n\tTracing Information from Decoder...\n\n");
	    decoded = (PayloadData)coder.decode(source, value);

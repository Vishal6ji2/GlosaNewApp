...
/**
 * Define the DYearMonth ASN.1 type included in the DSRC ASN.1 module.
 * @see Sequence
 */

public class DYearMonth extends Sequence implements JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
    public DYear year;
    public DMonth month;
	...
	try {
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "DYearMonth");
	    throw ee;
	}
    }
	...
	try {
	    ...
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "DYearMonth");
	    throw de;
	}
    }

...
import com.example.glosanewapp.j2735.dsrc.URL_Link;
...
/**
 * Define sample code for the URL_Link ASN.1 type included in the DSRC ASN.1 module.
 * @see URL_Link
 */

public class URL_LinkSample extends SampleUtil {

    /**
     * The default constructor. The class is not instantiable.
     */
    private URL_LinkSample() {}

    /**
     * Create Sample Value.
     */
    public static URL_Link createSampleValue()
    {
	URL_Link value = new URL_Link(
	"URL-Link");
	return value;
    }
    
    public static void printValue(URL_Link value, PrintStream s)
    {
	
	s.print("\"" + value.stringValue() + "\"");
    }
    
    public static int encodeDecodeAndPrint(URL_Link value, int run)
    {
	...
	URL_Link decoded = null;
	try {
	    System.out.print("\n\tTracing Information from Decoder...\n\n");
	    decoded = (URL_Link)coder.decode(source, value);

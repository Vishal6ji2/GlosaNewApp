...
/**
 * Define the Node-XY-32b ASN.1 type included in the DSRC ASN.1 module.
 * @see Sequence
 */
...
public class Node_XY_32b extends Sequence {
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, Node_XY_32b data)
	...
	try {
	    ...
	    ee.appendFieldContext("x", "Offset-B16");
	    throw ee;
	}
	// Encode field 'y'
	try {
	    Offset_B16 item1 = data.y;
	    long temp1 = item1.longValue();
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext("y", "Offset-B16");
	    throw ee;
	}
     ...
     * @exclude
     */
    public static Node_XY_32b decodeValue(PerCoder coder, InputBitStream source, Node_XY_32b data)
	...
	try {
	    ...
	    de.appendFieldContext("x", "Offset-B16");
	    throw de;
	}
	// Decode field 'y'
	try {
	    ...
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext("y", "Offset-B16");
	    throw de;
	}
	return data;
    }
     ...
     * @exclude
     */
    public Node_XY_32b decodeValue(JsonCoder coder, JsonReader source)
    ...
    {
	return equalTo((Node_XY_32b)that);
    }
    ...
    public boolean equalTo(Node_XY_32b that) {
     ...
     * Clone 'this' object.
     */
    public Node_XY_32b clone() {
	Node_XY_32b copy = (Node_XY_32b)super.clone();
	copy.x = x.clone();
	copy.y = y.clone();
	return copy;
    }

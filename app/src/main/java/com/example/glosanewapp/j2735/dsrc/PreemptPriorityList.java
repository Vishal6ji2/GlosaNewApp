...
/**
 * Define the PreemptPriorityList ASN.1 type included in the DSRC ASN.1 module.
 * @see SequenceOf
 */
...
public class PreemptPriorityList extends SequenceOf<SignalControlZone> {
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, PreemptPriorityList data)
     ...
     * @exclude
     */
    public static PreemptPriorityList decodeValue(PerCoder coder, InputBitStream source, PreemptPriorityList data)
     ...
     * @exclude
     */
    public PreemptPriorityList decodeValue(JsonCoder coder, JsonReader source)
    ...
    public void printValue(DataPrinter printer, java.io.PrintWriter writer)
	    throws Exception
    {
	java.util.ArrayList<SignalControlZone> temp0 = this.elements;
    ...
    {
	return equalTo((PreemptPriorityList)that);
    }
    ...
    public boolean equalTo(PreemptPriorityList that) {
     ...
     * Clone 'this' object.
     */
    public PreemptPriorityList clone() {
	PreemptPriorityList copy = (PreemptPriorityList)super.clone();

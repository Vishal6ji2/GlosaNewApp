...
/**
 * Define the LaneList ASN.1 type included in the DSRC ASN.1 module.
 * @see SequenceOf
 */
...
public class LaneList extends SequenceOf<GenericLane> {
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, LaneList data)
     ...
     * @exclude
     */
    public static LaneList decodeValue(PerCoder coder, InputBitStream source, LaneList data)
     ...
     * @exclude
     */
    public LaneList decodeValue(JsonCoder coder, JsonReader source)
    ...
    public boolean equalTo(LaneList that) {
     ...
     * Clone 'this' object.
     */
    public LaneList clone() {
	LaneList copy = (LaneList)super.clone();

...
/**
 * Define the TestMessage07 ASN.1 type included in the DSRC ASN.1 module.
 * @see Sequence
 */

public class TestMessage07 extends Sequence implements JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
	...
	/** Decode root fields **/
		...
		if (coder.getOption(com.oss.coders.Coder.cAUTOMATIC_ENCDEC)) {
		    ...
		    REG_EXT_ID_AND_TYPE_OSET oset1 = REGION.reg_TestMessage07;
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, TestMessage07 data)
	    throws IOException, EncoderException, EncodeFailedException
    {
	int nbits = 0;
	...
	try {
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "TestMessage07");
	    throw ee;
	}
    }
     ...
     * @exclude
     */
    public static TestMessage07 decodeValue(PerCoder coder, InputBitStream source, TestMessage07 data)
	    throws IOException, DecoderException, DecodeFailedException
    {
 ...
 // coder.setUnknownExtensionFound();
	...
	try {
	    ...
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "TestMessage07");
	    throw de;
	}
    }
     ...
     * @exclude
     */
    public TestMessage07 decodeValue(JsonCoder coder, JsonReader source)
	    throws IOException, DecoderException
    {
	boolean[] present0 = new boolean[3];
    ...
    public boolean abstractEqualTo(AbstractData that)
    {
	return equalTo((TestMessage07)that);
    }
    ...
    public boolean equalTo(TestMessage07 that) {
	if (this.header != null) {
     ...
     * Clone 'this' object.
     */
    public TestMessage07 clone() {
	TestMessage07 copy = (TestMessage07)super.clone();
	if (header != null) {

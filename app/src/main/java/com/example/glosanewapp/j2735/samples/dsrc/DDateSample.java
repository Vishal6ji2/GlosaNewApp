...
import com.example.glosanewapp.j2735.dsrc.DDate;
...
/**
 * Define sample code for the DDate ASN.1 type included in the DSRC ASN.1 module.
 * @see DDate
 */

public class DDateSample extends SampleUtil {
     ...
     * Create Sample Value.
     */
    public static DDate createSampleValue()
    {
	DDate value = new DDate();
    ...
    public static void printValue(DDate value, PrintStream s)
    {
	{
	    s.print("{");
	    ++indentlevel;
    ...
    public static int encodeDecodeAndPrint(DDate value, int run)
    {
	...
	try {
	    ...
	    decoded = (DDate)coder.decode(source, value);

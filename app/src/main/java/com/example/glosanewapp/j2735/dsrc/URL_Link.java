...
/**
 * Define the URL-Link ASN.1 type included in the DSRC ASN.1 module.
 * @see IA5String
 */

public class URL_Link extends IA5String implements JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
	...
	try {
	    ...
	    return com.oss.coders.per.PerKMCString.encode(coder, this.mValue, 1, 255, _cEPAInfo_, sink);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "URL-Link");
	    throw ee;
	}
    }
    ...
    {
	try {
	    this.mValue = com.oss.coders.per.PerKMCString.decode(coder, source, 1, 255, _cEPAInfo_);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "URL-Link");
	    throw de;
	}
    }
    ...
    {
	try {
	    coder.encodeString(this.stringValue(), sink);
    ...
    {
	try {
	    this.mValue = coder.decodeString(source);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "URL-Link");

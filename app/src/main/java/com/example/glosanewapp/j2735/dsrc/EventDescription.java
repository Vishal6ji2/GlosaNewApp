...
import com.example.glosanewapp.j2735.itis.ITIScodes;
...
/**
 * Define the EventDescription ASN.1 type included in the DSRC ASN.1 module.
 * @see Sequence
 */

public class EventDescription extends Sequence {
    public ITIScodes typeEvent;
     ...
     */
    public EventDescription(ITIScodes typeEvent, 
     ...
     * @see SequenceOf
     */
    public static class Description extends SequenceOf<ITIScodes> {
	 ...
	 */
	public Description(ITIScodes[] elements)
	{
	    super(elements);
	}
		...
		throws IOException, EncoderException, EncodeFailedException
	{
	    ...
	    while (total_len0 > 0) {
		try {
		    ITIScodes item1 = data.elements.get(idx0);
		...
		throws IOException, DecoderException, DecodeFailedException
	{
		...
		data.elements = new java.util.ArrayList<ITIScodes>(fragmentLength0);
	    while (idx0 > 0) {
		try {
		...
		throws IOException, EncoderException
	{
		...
		while (true) {
		    try {
			ITIScodes item1 = this.elements.get(idx0);
		...
		throws IOException, DecoderException
	{
		...
		this.elements = new java.util.ArrayList<ITIScodes>(total_len0);
	...
	public void printValue(DataPrinter printer, java.io.PrintWriter writer)
		throws Exception
	{
	    java.util.ArrayList<ITIScodes> temp0 = this.elements;
	...
	public Description clone() {
	    ...
	    copy.elements = new java.util.ArrayList<ITIScodes>(elements.size());
	    for (ITIScodes element : elements) {
	...
	/**
	 * Define the _seq23 ASN.1 type included in the DSRC ASN.1 module.
	 * @see Sequence
	 */
	public static class Sequence_ extends Sequence {
		...
		try {
			...
			REG_EXT_ID_AND_TYPE_OSET oset1 = REGION.reg_EventDescription;
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, EventDescription data)
	    throws IOException, EncoderException, EncodeFailedException
    {
	int nbits = 0;
	...
	try {
	    ITIScodes item1 = data.typeEvent;
	    long temp1 = item1.longValue();
	...
	if (data.heading != null) {
		...
		total_len1 = com.oss.util.BitTool.computeMinimalLength(item1, EventDescription._cBounds_heading);
		if (total_len1 != 16)
     ...
     * @exclude
     */
    public static EventDescription decodeValue(PerCoder coder, InputBitStream source, EventDescription data)
	    throws IOException, DecoderException, DecodeFailedException
    {
	...
	if (has_heading0) {
		...
		if (coder.isStrictCodingEnabled() && data.heading.getSize() >
		    com.oss.util.BitTool.computeMinimalLength(data.heading, EventDescription._cBounds_heading))
 ...
 // coder.setUnknownExtensionFound();
	...
	// Encode field 'typeEvent'
	try {
	    ITIScodes item1 = this.typeEvent;
     ...
     * @exclude
     */
    public EventDescription decodeValue(JsonCoder coder, JsonReader source)
	    throws IOException, DecoderException
    {
    ...
    public boolean abstractEqualTo(AbstractData that)
    {
	return equalTo((EventDescription)that);
    }
    ...
    public boolean equalTo(EventDescription that) {
	...
	EventDescription copy = (EventDescription)super.clone();

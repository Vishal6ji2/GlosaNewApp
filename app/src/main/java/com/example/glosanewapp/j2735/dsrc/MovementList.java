...
/**
 * Define the MovementList ASN.1 type included in the DSRC ASN.1 module.
 * @see SequenceOf
 */
...
public class MovementList extends SequenceOf<MovementState> {
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, MovementList data)
     ...
     * @exclude
     */
    public static MovementList decodeValue(PerCoder coder, InputBitStream source, MovementList data)
     ...
     * @exclude
     */
    public MovementList decodeValue(JsonCoder coder, JsonReader source)
    ...
    public void printValue(DataPrinter printer, java.io.PrintWriter writer)
	    throws Exception
    {
	java.util.ArrayList<MovementState> temp0 = this.elements;
    ...
    {
	return equalTo((MovementList)that);
    }
    ...
    public boolean equalTo(MovementList that) {
     ...
     * Clone 'this' object.
     */
    public MovementList clone() {
	MovementList copy = (MovementList)super.clone();

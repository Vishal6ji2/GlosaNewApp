...
/**
 * Define the NodeAttributeSetXY ASN.1 type included in the DSRC ASN.1 module.
 * @see Sequence
 */

public class NodeAttributeSetXY extends Sequence {
    public NodeAttributeXYList localNode;
    public SegmentAttributeXYList disabled;
    public SegmentAttributeXYList enabled;
	...
	/**
	 * Define the _seq37 ASN.1 type included in the DSRC ASN.1 module.
	 * @see Sequence
	 */
	public static class Sequence_ extends Sequence {
		...
		try {
			...
			REG_EXT_ID_AND_TYPE_OSET oset1 = REGION.reg_NodeAttributeSetXY;
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, NodeAttributeSetXY data)
	    throws IOException, EncoderException, EncodeFailedException
    {
	int nbits = 0;
	...
	if (data.localNode != null) {
	    ...
	    try {
		NodeAttributeXYList item1 = data.localNode;

		nbits += NodeAttributeXYList.encodeValue(coder, sink, item1);
	    } catch (Exception e) {
		EncoderException ee = EncoderException.wrapException(e);
		ee.appendFieldContext("localNode", "NodeAttributeXYList");
		throw ee;
	    }
	}
	if (data.disabled != null) {
	    ...
	    try {
		SegmentAttributeXYList item1 = data.disabled;

		nbits += SegmentAttributeXYList.encodeValue(coder, sink, item1);
	    } catch (Exception e) {
		EncoderException ee = EncoderException.wrapException(e);
		ee.appendFieldContext("disabled", "SegmentAttributeXYList");
		throw ee;
	    }
	}
	if (data.enabled != null) {
	    ...
	    try {
		SegmentAttributeXYList item1 = data.enabled;

		nbits += SegmentAttributeXYList.encodeValue(coder, sink, item1);
	    } catch (Exception e) {
		EncoderException ee = EncoderException.wrapException(e);
		ee.appendFieldContext("enabled", "SegmentAttributeXYList");
		throw ee;
	    }
	}
	if (data.data != null) {
     ...
     * @exclude
     */
    public static NodeAttributeSetXY decodeValue(PerCoder coder, InputBitStream source, NodeAttributeSetXY data)
	    throws IOException, DecoderException, DecodeFailedException
    {
	...
	if (has_localNode0) {
	    ...
	    try {
		if (data.localNode == null)
		    data.localNode = new NodeAttributeXYList();
		data.localNode.decodeValue(coder, source, data.localNode);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
		de.appendFieldContext("localNode", "NodeAttributeXYList");
		throw de;
	    }
	} else {
	    data.localNode = null;
	...
	if (has_disabled0) {
	    ...
	    try {
		if (data.disabled == null)
		    data.disabled = new SegmentAttributeXYList();
		data.disabled.decodeValue(coder, source, data.disabled);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
		de.appendFieldContext("disabled", "SegmentAttributeXYList");
		throw de;
	    }
	} else {
	    data.disabled = null;
	...
	if (has_enabled0) {
	    ...
	    try {
		if (data.enabled == null)
		    data.enabled = new SegmentAttributeXYList();
		data.enabled.decodeValue(coder, source, data.enabled);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
		de.appendFieldContext("enabled", "SegmentAttributeXYList");
		throw de;
	    }
	} else {
	    data.enabled = null;
 ...
 // coder.setUnknownExtensionFound();
	...
	// Encode field 'localNode'
	try {
	    NodeAttributeXYList item1 = this.localNode;
	...
	// Encode field 'disabled'
	try {
	    SegmentAttributeXYList item1 = this.disabled;
	...
	// Encode field 'enabled'
	try {
	    SegmentAttributeXYList item1 = this.enabled;
     ...
     * @exclude
     */
    public NodeAttributeSetXY decodeValue(JsonCoder coder, JsonReader source)
	    throws IOException, DecoderException
    {
	...
	if (coder.hasMoreProperties(source, true))
		...
		switch (t_tag0) {
			...
			if (!coder.isNullValue(source)) {
				...
				this.localNode = new NodeAttributeXYList();
    ...
    public boolean abstractEqualTo(AbstractData that)
    {
	return equalTo((NodeAttributeSetXY)that);
    }
    ...
    public boolean equalTo(NodeAttributeSetXY that) {
	if (this.localNode != null) {
     ...
     * Clone 'this' object.
     */
    public NodeAttributeSetXY clone() {
	NodeAttributeSetXY copy = (NodeAttributeSetXY)super.clone();
	if (localNode != null) {

...
/**
 * Define the LaneAttributes-Parking ASN.1 type included in the DSRC ASN.1 module.
 * @see BitString
 */
...
public class LaneAttributes_Parking extends BitString {
     ...
     * Clone 'this' object.
     */
    public LaneAttributes_Parking clone() {
	return (LaneAttributes_Parking)super.clone();
    }

...
package com.example.glosanewapp.j2735.itis;
...
/**
 * Define the ITIScodesAndText ASN.1 type included in the ITIS ASN.1 module.
 * @see SequenceOf
 */
...
public class ITIScodesAndText extends SequenceOf<ITIScodesAndText.Sequence_> {
    ...
    /**
     * Define the _seq47 ASN.1 type included in the ITIS ASN.1 module.
     * @see Sequence
     */
	...
	/**
	 * Define the Item ASN.1 type included in the ITIS ASN.1 module.
	 * @see Choice
	 */
	public static class Item extends Choice {
		...
		case itis_chosen:
		    try {
			writer.print("itis : ");
			writer.print(((ITIScodes)this.mChosenValue).longValue());
		    } catch (Exception e) {
		...
		case text_chosen:
		    try {
			writer.print("text : ");
			printer.print(((ITIStext)this.mChosenValue), writer);
		    } catch (Exception e) {
			printer.reportError(e, null, writer);
		    }
		    break;

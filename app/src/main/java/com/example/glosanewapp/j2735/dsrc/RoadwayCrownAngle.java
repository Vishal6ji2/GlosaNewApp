...
/**
 * Define the RoadwayCrownAngle ASN.1 type included in the DSRC ASN.1 module.
 * @see INTEGER
 */
...
public class RoadwayCrownAngle extends INTEGER {
     ...
     * Clone 'this' object.
     */
    public RoadwayCrownAngle clone() {
	RoadwayCrownAngle copy = (RoadwayCrownAngle)super.clone();

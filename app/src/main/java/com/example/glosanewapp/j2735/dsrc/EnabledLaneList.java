...
/**
 * Define the EnabledLaneList ASN.1 type included in the DSRC ASN.1 module.
 * @see SequenceOf
 */
...
public class EnabledLaneList extends SequenceOf<LaneID> {
     ...
     * @exclude
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, EnabledLaneList data)
     ...
     * @exclude
     */
    public static EnabledLaneList decodeValue(PerCoder coder, InputBitStream source, EnabledLaneList data)
     ...
     * @exclude
     */
    public EnabledLaneList decodeValue(JsonCoder coder, JsonReader source)
    ...
    {
	return equalTo((EnabledLaneList)that);
    }
    ...
    public boolean equalTo(EnabledLaneList that) {
     ...
     * Clone 'this' object.
     */
    public EnabledLaneList clone() {
	EnabledLaneList copy = (EnabledLaneList)super.clone();

...
import com.example.glosanewapp.j2735.ntcip.EssMobileFriction;
import com.example.glosanewapp.j2735.ntcip.EssPrecipRate;
import com.example.glosanewapp.j2735.ntcip.EssPrecipSituation;
import com.example.glosanewapp.j2735.ntcip.EssPrecipYesNo;
import com.example.glosanewapp.j2735.ntcip.EssSolarRadiation;
import com.oss.asn1.*;
...
public class VehicleStatus extends Sequence {
	...
	public EssPrecipYesNo isRaining;
	public EssPrecipRate rainRate;
	public EssPrecipSituation precipSituation;
	public EssSolarRadiation solarRadiation;
	public EssMobileFriction friction;
	 ...
	 * Construct with AbstractData components.
	 */
	public WeatherReport(EssPrecipYesNo isRaining, 
		...
		throws IOException, EncoderException, EncodeFailedException
	{
	    ...
	    try {
		EssPrecipYesNo item1 = data.isRaining;
		int idx1 = item1.indexOf();
		...
		try {
		    EssPrecipRate item1 = data.rainRate;
		    long temp1 = item1.longValue();
		...
		try {
		    EssPrecipSituation item1 = data.precipSituation;
		    int idx1 = item1.indexOf();
		...
		try {
		    EssSolarRadiation item1 = data.solarRadiation;
		    long temp1 = item1.longValue();
		...
		try {
		    EssMobileFriction item1 = data.friction;
		    long temp1 = item1.longValue();
	...
	/** Decode root fields **/
		...
		if (idx1 < 0 || idx1 > 2)
		    throw new DecoderException(ExceptionDescriptor._not_enumerated, null, "index = " + idx1);
		data.isRaining = EssPrecipYesNo.valueAt(idx1);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
		...
		try {
		    ...
		    if (data.rainRate == null)
			data.rainRate = new EssPrecipRate();
		...
		try {
		    ...
		    if (idx1 < 0 || idx1 > 14)
			throw new DecoderException(ExceptionDescriptor._not_enumerated, null, "index = " + idx1);
		    data.precipSituation = EssPrecipSituation.valueAt(idx1);
		} catch (Exception e) {
		    DecoderException de = DecoderException.wrapException(e);
		...
		try {
		    ...
		    if (data.solarRadiation == null)
			data.solarRadiation = new EssSolarRadiation();
		    temp1 = coder.decodeConstrainedWholeNumber(source, 0, 65535);
		    if (temp1 > 65535)
			throw new DecoderException(ExceptionDescriptor._valueRange, null, temp1);
		...
		try {
		    ...
		    if (data.friction == null)
			data.friction = new EssMobileFriction();
		...
		throws IOException, EncoderException
	{
	    ...
	    // Encode field 'isRaining'
	    try {
		EssPrecipYesNo item1 = this.isRaining;
	    ...
	    // Encode field 'rainRate'
	    try {
		EssPrecipRate item1 = this.rainRate;
	    ...
	    // Encode field 'precipSituation'
	    try {
		EssPrecipSituation item1 = this.precipSituation;
	    ...
	    // Encode field 'solarRadiation'
	    try {
		EssSolarRadiation item1 = this.solarRadiation;
	    ...
	    // Encode field 'friction'
	    try {
		EssMobileFriction item1 = this.friction;
		...
		throws IOException, DecoderException
	{
		...
		do {
			...
			try {
			    String content1 = coder.decodeString(source);
			    int idx1;
			    EssPrecipYesNo temp1;

			    if (present0[0])
				throw new DecoderException(ExceptionDescriptor._field_repeat, null);
			    idx1 = coder.resolveName(EssPrecipYesNo.cConstantNameList, content1);
			    if (idx1 < 0 )
				throw new DecoderException(ExceptionDescriptor._not_enumerated, null, "value = " + content1);
			    else
				temp1 = EssPrecipYesNo.cNamedNumbers[idx1];
			...
			try {
				...
				if (this.rainRate == null)
				    this.rainRate = new EssPrecipRate();
			...
			try {
				...
				String content1 = coder.decodeString(source);
				int idx1;
				EssPrecipSituation temp1;

				if (present0[2])
				    throw new DecoderException(ExceptionDescriptor._field_repeat, null);
				idx1 = coder.resolveName(EssPrecipSituation.cConstantNameList, content1);
				if (idx1 < 0 )
				    throw new DecoderException(ExceptionDescriptor._not_enumerated, null, "value = " + content1);
				else
				    temp1 = EssPrecipSituation.cNamedNumbers[idx1];
			...
			try {
				...
				if (this.solarRadiation == null)
				    this.solarRadiation = new EssSolarRadiation();
			...
			try {
				...
				if (this.friction == null)
				    this.friction = new EssMobileFriction();

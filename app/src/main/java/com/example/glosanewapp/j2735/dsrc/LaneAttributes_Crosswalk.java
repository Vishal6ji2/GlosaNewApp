...
/**
 * Define the LaneAttributes-Crosswalk ASN.1 type included in the DSRC ASN.1 module.
 * @see BitString
 */
...
public class LaneAttributes_Crosswalk extends BitString {
     ...
     * Clone 'this' object.
     */
    public LaneAttributes_Crosswalk clone() {
	return (LaneAttributes_Crosswalk)super.clone();
    }
